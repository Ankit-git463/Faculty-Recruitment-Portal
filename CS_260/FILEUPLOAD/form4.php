...
<body>
    ...
    <div id="uploaded-files">
        <?php
        // Display links to uploaded files from the current session
        if (isset($_SESSION['uploaded_files'])) {
            foreach ($_SESSION['uploaded_files'] as $file) {
                echo "<div><a href='" . htmlspecialchars($file['filepath']) . "' target='_blank'>" . htmlspecialchars($file['filename']) . "</a></div>";
            }
        } else {
