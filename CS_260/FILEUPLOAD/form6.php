...
// Clear the session files on page load to refresh links
...
<body>
    ...
    <div class="upload-section">
        ...
        if (isset($_SESSION['uploaded_files']['file1'])) {
            ...
            echo "<a href='" . htmlspecialchars($file['filepath']) . "' target='_blank'>View File 1: " . htmlspecialchars($file['filename']) . "</a>";
        }
        ?>
    </div>
    ...
    <div class="upload-section">
        ...
        if (isset($_SESSION['uploaded_files']['file2'])) {
            ...
            echo "<a href='" . htmlspecialchars($file['filepath']) . "' target='_blank'>View File 2: " . htmlspecialchars($file['filename']) . "</a>";
        }
        ?>
    </div>
    ...
    <div class="upload-section">
        ...
        if (isset($_SESSION['uploaded_files']['file3'])) {
            ...
            echo "<a href='" . htmlspecialchars($file['filepath']) . "' target='_blank'>View File 3: " . htmlspecialchars($file['filename']) . "</a>";
        }
        ?>
    </div>
    ...
    <div class="upload-section">
        ...
        if (isset($_SESSION['uploaded_files']['file4'])) {
            ...
            echo "<a href='" . htmlspecialchars($file['filepath']) . "' target='_blank'>View File 4: " . htmlspecialchars($file['filename']) . "</a>";
        }
        ?>
    </div>
</body>
